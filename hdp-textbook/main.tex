...
&\overset{(i)}\leq 1 + 2\sum_{k=1}^{\infty} \frac{\lambda^{2k}}{(2k)!}\Exp[|X|^{2k}] \\
&\leq 1 + 2\sum_{k=1}^{\infty} \frac{\lambda^{2k}}{(2k)!} 2K_{1}^{2k}\underbrace{k\Gamma(k)}_{k!} \\
&\leq 1 + \sum_{k=1}^{\infty} \lambda^{2k}K_{1}^{2k} \frac{2^{k}k!}{(2k)!} \\
&\leq \sum_{k=0}^{\infty} \frac{\lambda^{2k}(K_{1})^{2k}}{k!} = \exp(\lambda^{2}K_{1}^{2})
\end{align*}
where in Step \((i)\) we have bounded odd moments using even moments.
...
\begin{remark}
Note that (ii) states that sub-Gaussian random variables have bounded moments.
\end{remark}
